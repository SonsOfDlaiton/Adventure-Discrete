...
const double Constants::ENTITY_VerticalRecoil=330.0f;
const double Constants::ENTITY_WalkSpeed=166.0f;
const double Constants::ENTITY_RunAcceleration=70.0f;
const double Constants::ENTITY_MaxRunSpeed=280.0f;
const double Constants::ENTITY_ImunityTime=400.0f;

const int Constants::MAP_AmountOfBackgrounds=3;
const int Constants::MAP_AmountOfUserMaps=6;
const int Constants::MAP_AmountOfMaps=6;

const double Constants::MECHANICS_Gravity=500.0f;
...
const double Constants::TEXTURE_DefaultTimeToNext=150.0f;
